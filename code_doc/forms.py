...
class ArtifactEditionForm(ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            ...
            # 'branch': 'If this file was generated by a particular branch of the code, you may indicate it here.',
            'revision': 'If this file was generated by a particular revision of the code, you may indicate it here.',
        }
        widgets = {
            'description': Textarea(attrs={'cols': 60,
                                           'rows': 10,
                                           'style': "resize:vertical; width: 100%; min-height: 50px;"}),
            'upload_date': DateInput(attrs={'class': 'datepicker',
                                            'data-date-format': "dd/mm/yyyy",
                                            'data-provide': 'datepicker'},
                                     format='%d/%m/%Y'),
        }
    ...
    if 0:
        def clean_revision(self):
            # not enforcing that this revision exists now, will be in the model validation
            print 'clean revision'
            import ipdb
            ipdb.set_trace()
            return self.cleaned_data['revision']

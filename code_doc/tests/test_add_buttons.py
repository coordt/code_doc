...
class TemplateAddButtonTest(TestCase):
    def setUp(self):
        ...
        self.admin_user = User.objects.create_superuser(
            username="admin", email="blah@blah.com", password="test"
        )
    ...
    def test_add_series_button_disabled(self):
        ...
        not_allowed_for_project = User.objects.create_user(
            username="not", password="allowed", email="a@a.com"
        )
...
class TemplateSeriesAddButtonTest(TestCase):
    def setUp(self):
        ...
        self.test_user = User.objects.create_user(
            username="dirk", password="41", email="dirk@mavs.com"
        )
    ...
    def test_add_artifact_button_enabled(self):
        ...
        self.assertTrue(
            self.series.has_user_series_artifact_add_permission(self.test_user)
        )

...
class ProjectTest(TestCase):
    ...
    def test_project_details(self):
        ...
        self.assertEqual(
            len(response.context["authors"]), len(self.project.authors.all())
        )
    ...
    def test_project_administrator(self):
        ...
        self.assertTrue(
            self.project.has_user_project_series_add_permission(self.first_user)
        )
    ...
    def test_project_get_number_of_files(self):
        ...
        new_artifact = Artifact.objects.create(
            project=self.project, revision=revision, md5hash="0"
        )
        ...
        new_artifact2 = Artifact.objects.create(
            project=self.project, revision=revision, md5hash="1"
        )
...
class ProjectViewTest(TestCase):
    ...
    def test_link_last_artifact_doc(self):
        ...
        artifact0 = Artifact.objects.create(
...
class ProjectRepositoryTest(TestCase):
    def test_repository_unique_constraint(self):
        ...
        repository = "https://somewhere.gitlab"
        ProjectRepository.objects.create(project=project, code_source_url=repository)

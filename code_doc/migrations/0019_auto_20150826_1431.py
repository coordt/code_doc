    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                to="auth.Group", blank=True, related_name="perms_groups_artifacts_add"
            ),
        ),
        migrations.RenameField(
            model_name="projectseries",
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                to="auth.Group", blank=True, related_name="perms_users_artifacts_add"
            ),
        ),
        migrations.AddField(
            model_name="projectseries",
            ...
            field=models.ManyToManyField(
                to="auth.Group", blank=True, related_name="perms_groups_artifacts_del"
            ),
        ),
        migrations.AddField(
            model_name="projectseries",

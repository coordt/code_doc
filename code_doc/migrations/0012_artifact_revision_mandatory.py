...
def set_default_revision(apps, schema_editor):
    ...
    for art in Artifact.objects.all():
        art.revision = Revision.objects.create(revision=art.md5hash,
                                               project=art.project_series_backup.project)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            set_default_revision,
        ),
        migrations.AlterField(
            model_name='Artifact',
            name='revision',
            field=models.ForeignKey(related_name='artifacts', blank=False, null=False, to='code_doc.Revision')
        ),
        ...
        migrations.AddField(
            model_name='Artifact',
            name='project',
            field=models.ForeignKey(related_name='revisions', blank=True, null=True, to='code_doc.Project'),
        ),
        migrations.RunPython(
            set_project_for_artifact,
        ),
        migrations.AlterField(
            model_name='Artifact',
            name='project',
            field=models.ForeignKey(related_name='artifacts', blank=False, null=False, to='code_doc.Project'),
        ),
